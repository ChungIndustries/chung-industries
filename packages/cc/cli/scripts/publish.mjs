// Publishes dist/cli-<version>.tgz to the registry as the `cli` package.
...
// registry account page by the cli package's owner). Same no-fallback rule.
...
if (response.status === 409) {
  console.log(`cli@${version} is already published; nothing to do.`);
} else if (!response.ok) {
  process.exitCode = 1;
}
