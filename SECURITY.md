...
This is a generated TypeScript CLI for CPM Registry, produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the CPM Registry API or service rather than in this CLI, report it through the security process CPM Registry has published.
