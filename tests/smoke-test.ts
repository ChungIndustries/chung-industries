...
const cases: { operation: string; method: string; path: string; args: string[] }[] = [
...

  {
    ...
    method: 'GET',
    path: '/packages/{name}',
    args: ['packages', 'retrieve', 'example'],
  },

  {
    ...
    args: ['packages', 'retrieve-version', '1.0.0', '--name', 'example'],
  },

  {
    ...
    method: 'POST',
    path: '/resolve',
    args: ['packages', 'resolve', '--dependencies', '{}'],
  },

  {
    operation: 'listTarball',
    method: 'GET',
    path: '/packages/{name}/{version}/dist/tarball',
    args: ['packages:dist', 'list-tarball', '1.0.0', '--name', 'example'],
  },

  {
    operation: 'listBundle',
    method: 'GET',
    path: '/packages/{name}/{version}/dist/bundle',
    args: ['packages:dist', 'list-bundle', '1.0.0', '--name', 'example'],
  },

  {
    operation: 'listInstall',
    method: 'GET',
    path: '/install',
    args: ['bootstrap', 'list-install'],
  },
];
